...
- Sovelluksessa käyttäjät pystyvät etsimään peliseuraa jalkapalloon/Futsaliin. Ilmoituksessa lukee missä ja milloin pelivuoro on sekä tarvittava pelaajien määrä
- Käyttäjä pystyy luomaan tunnuksen ja kirjautumaan sisään sovellukseen.
- Käyttäjä pystyy lisäämään ilmoituksia, muokata ja poistaa niitä.
- Käyttäjä pystyy kommentoimaan ilmoituksiin.
...
- Käyttäjä pystyy valitsemaan ilmoitukselle taitotason.
